...
function renderRound() {
  ...
  root.appendChild(h('div', { class: 'hole-header' },
    ...
    h('div', { style: 'font-size:13px;font-weight:700;color:rgba(255,255,255,0.85);margin-top:6px;display:flex;gap:14px;justify-content:center;' },
      h('span', null, 'Top: ', h('span', { style: `color:${pressSlashColor(result.mode === '5man' ? result.game1.top : result.top, holesBefore)};` },
        pressSlashStr(result.mode === '5man' ? result.game1.top : result.top, holesBefore))),
      h('span', null, `Mid: ${tallyStr(beforeMid)}`),
      h('span', null, 'Bot: ', h('span', { style: `color:${pressSlashColor(result.mode === '5man' ? result.game1.bottom : result.bottom, holesBefore)};` },
        pressSlashStr(result.mode === '5man' ? result.game1.bottom : result.bottom, holesBefore)))
    ),
...
function renderLiveView() {
  ...
  root.appendChild(h('div', { class: 'result-banner' },
    ...
    h('div', { class: 'amount', style: `color:${midClr === 'var(--muted)' ? 'white' : midClr};` }, midStr)
  ));
